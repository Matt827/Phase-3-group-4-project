...
# pip install pygame
pygame.init()
weapon_sound = pygame.mixer.Sound("./lib/classes/assets/weapon.wav")
grunt = pygame.mixer.Sound("./lib/classes/assets/grunt.wav")
death = pygame.mixer.Sound("./lib/classes/assets/death.wav")
music = pygame.mixer.Sound("./lib/classes/assets/music.mp3")
level_complete = pygame.mixer.Sound("./lib/classes/assets/level_complete.wav")
